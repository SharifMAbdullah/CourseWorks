#include<string>
unsigned char key[32] = "Thats my Kung Fu"; //input key
unsigned char in[1024] = "Two One Nine Two", out[1024];
unsigned char state[4][4]; //intermediate results during encryption
unsigned char roundKey[240]; //iput key + expanded key

   
int keySize = 4; //4 words, 4*4 bytes, 16*8=128 bits
int totalRounds = 10;
int columns = 4;
