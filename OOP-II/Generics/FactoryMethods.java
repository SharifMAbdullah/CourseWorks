...
// Java SE 9 collection factory method
public class FactoryMethods {
	public static void main(String[] args) {
		...
		// create a Set
		Set<String> colorSet = Set.of("red", "orange", "yellow", "green", "blue", "indigo",
				"violet");
		System.out.printf("colorSet: %s%n%n", colorSet);
		
		// create a Map using method "of
		Map<String, Integer> dayMap = Map.of("Monday", 1, "Tuesday", 2, "Wednesday", 3, "Thursday",
				4, "Friday", 5, "Saturday", 6, "Sunday", 7);
